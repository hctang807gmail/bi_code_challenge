...
docker run -d --name broker_insights -e MYSQL_ROOT_PASSWORD=my-secret-pw -v $PWD/app/upload:/broker_insights/upload -v $PWD/app/config:/broker_insights/config broker_insights:code_challenge
