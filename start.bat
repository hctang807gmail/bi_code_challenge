...
docker run -d --name broker_insights -e MYSQL_ROOT_PASSWORD=my-secret-pw -v %CD%/app:/broker_insights1 -v %CD%/app/upload:/broker_insights/upload -v %CD%/app/config:/broker_insights/config broker_insights:code_challenge
